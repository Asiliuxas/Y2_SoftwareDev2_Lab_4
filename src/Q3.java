...
public class Q3 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = 1;i<=file_count;i++){
            ...
            temp_file.print(ReadFile.toString(".\\content\\out\\",file_name+i)
                    +ReadFile.assess(ReadFile.toString(".\\content\\out\\",file_name+i)));   // Give file_name[rand] content from file_name[i]
            ...
            temp_file.print(temp_content+ReadFile.assess(temp_content));                                                          // Give file_name[i] temp content
